...
Potresti utilizzare il portale clienti dell'infrastruttura {{site.data.keyword.BluSoftlayer_notm}}, invece della console {{site.data.keyword.Bluemix_notm}}, per i seguenti motivi:
  * Se utilizzi solo i servizi dell'infrastruttura {{site.data.keyword.Bluemix_notm}} (e non i servizi della piattaforma) e non disponi di un [account collegato](/docs/account?topic=account-unifyingaccounts#link_user_account).
  * Se non hai un [ID IBM](/docs/account?topic=account-unifyingaccounts#switchtoIBMid).
